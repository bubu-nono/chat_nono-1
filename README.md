...
export REDIS_URL="redis:xxxx"
export REDIS_PWD="xxxx"
export REDIS_USER="xxxx"
```

```railway
OPENAI_API_KEY=<your_openai_api_key>
OPENAI_ORGANIZATION_KEY=<your_organization_id>
CHATGPT_TRIGGER_KEYWORD=
REDIS_URL=redis://${{Redis.REDISHOST}}:${{Redis.REDISPORT}}/0
REDIS_PWD=${{Redis.REDISPASSWORD}}
...
[![Deploy on Railway](https://railway.app/button.svg)](https://railway.app/template/0FeC67?referralCode=xwAu5F)
